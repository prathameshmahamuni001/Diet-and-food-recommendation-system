...
import os
import re
os.environ['OPENAI_API_KEY'] = 'enteryours' # your openai key
...
prompt_template_resto = PromptTemplate(
    ...
    template="Diet Recommendation System:\n"
             "I want you to recommend 6 restaurants names famous, 6 breakfast names, 5 dinner names, and 6 workout names, "
